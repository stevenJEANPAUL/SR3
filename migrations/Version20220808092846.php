 ...
 */
final class Version20220808092846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, image_name VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', presentation LONGTEXT NOT NULL, image_name2 VARCHAR(255) NOT NULL, image_name3 VARCHAR(255) NOT NULL, photo VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) NOT NULL, titre2 VARCHAR(255) NOT NULL, poste VARCHAR(255) NOT NULL, titre3 VARCHAR(255) NOT NULL, presentation2 LONGTEXT NOT NULL, image_name4 VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
