 ...
 */
class getAccueilRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AccueilRepository' shared autowired service.
     *
     * @return \App\Repository\AccueilRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AccueilRepository.php';

        return $container->privates['App\\Repository\\AccueilRepository'] = new \App\Repository\AccueilRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
